...
<header class="admin-top"><div><img src="<?=htmlspecialchars($adminLogo)?>" alt=""><strong>Creative Garage Admin</strong></div><nav><a href="../" target="_blank">Ver site</a><a href="logout.php">Sair</a></nav></header>
